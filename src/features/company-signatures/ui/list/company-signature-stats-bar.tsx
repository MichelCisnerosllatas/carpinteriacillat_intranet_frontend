...
interface CompanySignatureStatsBarProps {
  total: number
  active: number
  inactive: number
}

export function CompanySignatureStatsBar({ total, active, inactive }: CompanySignatureStatsBarProps) {
  return (
    <div className="grid grid-cols-3 gap-3">
      {[
        { label: 'Firmas',    value: total,    color: 'text-foreground' },
