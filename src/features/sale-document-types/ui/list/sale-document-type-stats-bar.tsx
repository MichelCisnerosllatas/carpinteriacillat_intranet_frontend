...
interface SaleDocumentTypeStatsBarProps {
  total: number
  active: number
  inactive: number
}

export function SaleDocumentTypeStatsBar({ total, active, inactive }: SaleDocumentTypeStatsBarProps) {
  return (
    <div className="grid grid-cols-3 gap-3">
      {[
        { label: 'Tipos',     value: total,    color: 'text-foreground' },
