// src/features/typecolors/ui/list/typecolors-table.tsx
'use client'
...
export function TypeColorsTable() {
  const {
    ...
    load, reset,
  } = useTypeColorListStore()
  const { bulkToggleState, bulkDeleteItems } = useTypeColorDeleteStore()
        ...
        <Table>
          ...
          <TableBody>
            {table.getRowModel().rows?.length ? (
              ...
              <TableRow>
                <TableCell colSpan={typecolorsColumns.length} className="h-20 text-center text-sm text-muted-foreground">
