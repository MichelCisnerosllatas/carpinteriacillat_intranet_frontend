...
interface CompanyContactStatsBarProps {
  total: number
  active: number
  onWebsite: number
}

export function CompanyContactStatsBar({ total, active, onWebsite }: CompanyContactStatsBarProps) {
  return (
    <div className="grid grid-cols-3 gap-3">
      {[
        { label: 'Contactos', value: total, color: 'text-foreground' },
