...
import { Pencil, Tag, CalendarDays } from 'lucide-react'
...
export function CategoryDetail({ id }: { id: string }) {
  ...
  const { currentItem, items, setCurrentItem } = useCategoryListStore()
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="flex items-start gap-4">
            ...
            <Button variant="outline" size="sm" onClick={() => { NProgress.start(); router.push(`/categories/edit/${item.id}`) }}>
