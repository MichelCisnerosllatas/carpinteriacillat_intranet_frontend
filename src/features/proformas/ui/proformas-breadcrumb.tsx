...
export function ProformasBreadcrumb({ currentPage, showHeader = true }: ProformasBreadcrumbProps) {
  return (
    <div className="flex flex-col gap-4">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem><BreadcrumbLink asChild><Link href="/proformas">Proformas</Link></BreadcrumbLink></BreadcrumbItem>
          <BreadcrumbSeparator />
      ...
      {showHeader && (
        <div className="flex items-center gap-3">
          <Button variant="outline" size="icon" className="size-8 shrink-0" asChild>
            <Link href="/proformas"><ChevronLeft className="size-4" /></Link>
          </Button>
