// src/features/proformas/stores/usePendingCartItemsStore.ts
import { create } from 'zustand'
import type { CartItem, PendingCartItem } from '../lib/proforma-cart/types'

let nextTempId = 0

type State = {
  /** Productos agregados ANTES de que la proforma tenga id — la lista temporal del carrito.
   * Se recorre uno por uno para registrarlos en cuanto la proforma obtiene su id real. */
