...
import { TypeFontsRowActions } from './typefonts-row-actions'

function TypeFontNameCell({ font }: { font: TypeFont }) {
...
export const typefontsColumns: ColumnDef<TypeFont>[] = [
  {
    id: 'select',
    header: ({ table }) => (
      <Checkbox
...

  {
    ...
    header: ({ column }) => <DataTableColumnHeader column={column} title="Tipografía" />,
