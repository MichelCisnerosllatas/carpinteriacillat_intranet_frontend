...
interface TypeFontStatsBarProps {
  total: number
  active: number
  inactive: number
}

export function TypeFontStatsBar({ total, active, inactive }: TypeFontStatsBarProps) {
  return (
    <div className="grid grid-cols-3 gap-3">
      {[
        { label: 'Tipografías', value: total,    color: 'text-foreground' },
